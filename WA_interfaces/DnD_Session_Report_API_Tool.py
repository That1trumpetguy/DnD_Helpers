...
def Push_Session_Report(ai_Output, date):
...
def Push_AI_Gen_Contract(ai_Output, contract_subject):
    ...
    new_test_article = client.article.put({
        #Title for the article
        'title': f"AI Gen Contract {contract_subject}",
        #The display state of the article
        'state': "Private",
        'isWip': True, 
        'isDraft': True, 
        'icon': " ra-quill-ink",
        'excerpt': "This is an AI generated contract template",
        'allowComments': True,
        'content': ai_Output,
        #template type for the article to be generated
        'templateType': 'report',
    ...
    "cssClasses": "parchment-style",
        ...
        'category':{
            'id': "7031f1e7-e794-42e2-b627-b91477d63789"
        },
        'cover': {
            "id": 4970407
        }
